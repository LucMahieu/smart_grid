...
def plot_hillclimber_solution(district, hill_climber_object):
    """
    ...
    x = [point[0] for point in hill_climber_object['all_cables']]
    y = [point[1] for point in hill_climber_object['all_cables']]
